        ...
        >
          <div className="bg-white rounded-2xl mt-4 p-4 shadow-xl border border-gray-100">
            <div className="space-y-2">
              ...
              <Link to="/upload" className={mobileLinkClass("/upload")} onClick={() => setIsMobileMenuOpen(false)}>
                <span className="flex items-center gap-3">
              ...
              <Link to="/chatbot" className={mobileLinkClass("/chatbot")} onClick={() => setIsMobileMenuOpen(false)}>
                <span className="flex items-center gap-3">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8-4.97 0-9-3.582-9-8s4.03-8 9-8 9 3.582 9 8z" />
                  </svg>
